"""
Example: Use the combined Dashboard (video + plots in one window).
"""
...
def process_frame(frame):
    ...
    blink = 1.0 if np.random.rand() < 0.05 else 0.0
...
def main():
    ...
    # Create and run dashboard with horizontal layout
    with Dashboard(video, plot_specs, update_interval_ms=100,
                   layout='horizontal', window_name='EyeTrace Dashboard') as dashboard:
        print("Dashboard running in one window. Press 'q' to quit.")
